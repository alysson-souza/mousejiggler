...
set COMPILE_CMD=cl /W4 /O2 /std:c11 /D_UNICODE /DUNICODE /I%INCLUDE_DIR%
...
echo Linking...
set LINK_CMD=link /SUBSYSTEM:WINDOWS user32.lib gdi32.lib comctl32.lib shell32.lib advapi32.lib
